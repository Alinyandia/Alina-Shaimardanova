...
def first(k):
    ...
    l = 0
    if not k.isdigit():
        req = urllib.request.Request('https://api.vk.com/method/wall.get?domain=' + str(k) + '&access_token=c36145c4aee3eb5dd4f1f1a6aab481c2c236b3afbcb440606416729f7fc8d28b5ddc6127d7a6dae599134')
        ...
        if data['response'][0] >= 400:
            while l != 400:
                i = 0
                req = urllib.request.Request('https://api.vk.com/method/wall.get?domain=' + str(k) + '&count=100&offset=' + str(l) + '&access_token=c36145c4aee3eb5dd4f1f1a6aab481c2c236b3afbcb440606416729f7fc8d28b5ddc6127d7a6dae599134') 
                response = urllib.request.urlopen(req)
                result = response.read().decode('utf-8')
                data = json.loads(result)
                time.sleep(0.15)
            ...
            while l < data['response'][0]-10:
                i = 0
                req = urllib.request.Request('https://api.vk.com/method/wall.get?domain=' + str(k) + '&count=10&offset=' + str(l) + '&access_token=c36145c4aee3eb5dd4f1f1a6aab481c2c236b3afbcb440606416729f7fc8d28b5ddc6127d7a6dae599134') 
                response = urllib.request.urlopen(req)
                result = response.read().decode('utf-8')
                data = json.loads(result)
                time.sleep(0.15)
        ...
        req = urllib.request.Request('https://api.vk.com/method/wall.get?owner_id=' + str(k) + '&access_token=c36145c4aee3eb5dd4f1f1a6aab481c2c236b3afbcb440606416729f7fc8d28b5ddc6127d7a6dae599134')
        response = urllib.request.urlopen(req)
        result = response.read().decode('utf-8')
        data = json.loads(result)
        if data['response'][0] >= 400:
            while l != 400:
                i = 0
                req = urllib.request.Request('https://api.vk.com/method/wall.get?owner_id=' + str(k) + '&count=100&offset=' + str(l) + '&access_token=c36145c4aee3eb5dd4f1f1a6aab481c2c236b3afbcb440606416729f7fc8d28b5ddc6127d7a6dae599134') 
                response = urllib.request.urlopen(req)
                result = response.read().decode('utf-8')
                data = json.loads(result)
                time.sleep(0.15)
            ...
            while l < data['response'][0]-10:
                i = 0
                req = urllib.request.Request('https://api.vk.com/method/wall.get?owner_id=' + str(k) + '&count=10&offset=' + str(l) + '&access_token=c36145c4aee3eb5dd4f1f1a6aab481c2c236b3afbcb440606416729f7fc8d28b5ddc6127d7a6dae599134') 
                response = urllib.request.urlopen(req)
                result = response.read().decode('utf-8')
                data = json.loads(result)
                time.sleep(0.15)
